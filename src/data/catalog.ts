...
export const SKILLS: SkillDef[] = [
  ...
  },
  {
    ...
    detail: "只縮短此卡自身的復活等待。",
    playTip: "持有兩個或三個復活的武將，自身返場較快。擊破後應趁其尚未復活時推城或轉換進攻點。",
    kind: "combat",
    facts: [
  ...
  },
  {
    ...
    detail:
      "遠離敵部隊／敵城時進入隠密，敵軍無法看見，亦看不見出城煙。靠近約 1.5 卡距離或敵城第一格、撞柵櫓、被傷害計略打中、被兵種動作打中會解除。離開後過一段時間會再隠密。弓通常無法鎖定隠密目標。突擊氣場、槍氣場、出入城特效都會藏起。",
